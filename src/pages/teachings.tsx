  ...
  return (
    <div className="w-full py-4  min-h-screen">
      <main className="container mx-auto px-6 py-10">
        ...
        >
          <h3 className="text-xl font-semibold text-blue-700 mb-3">Ongoing</h3>
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300 border-l-4 border-blue-600">
        ...
        >
          <h3 className="text-xl font-semibold text-blue-700 mb-3"> Lecture Videos</h3>
        ...
        >
          <h3 className="text-xl font-semibold text-blue-700 mb-3">Plagiarism Policy</h3>
          <p className="text-sm text-red-700 bg-red-50 p-3 rounded shadow-inner border border-red-200">
